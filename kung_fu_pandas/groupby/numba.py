...
def _apply_group_method_single_chunk(
    ...
    --------
    >>> import numpy as np
    >>> from kung_fu_pandas.groupby.numba import _apply_group_method_single_chunk
    >>>
...
def reduce_array_pair(
    ...
    --------
    >>> import numpy as np
    >>> from kung_fu_pandas.groupby.numba import reduce_array_pair, ScalarFuncs
    >>>
...
def combine_chunk_results_for_unfactorized_key(
    ...
    --------
    >>> import numpy as np
    >>> from kung_fu_pandas.groupby.numba import combine_chunk_results_for_unfactorized_key, ScalarFuncs
    >>>
...
def combine_chunk_results_for_factorized_key(
    ...
    --------
    >>> import numpy as np
    >>> from kung_fu_pandas.groupby.numba import combine_chunk_results_for_factorized_key, ScalarFuncs
    >>>
...
def group_count(
    ...
    --------
    >>> import numpy as np
    >>> from kung_fu_pandas.groupby.numba import group_count
...
def rolling_sum(
    ...
    --------
    >>> import numpy as np
    >>> from kung_fu_pandas.groupby.numba import rolling_sum
    >>>
    >>> # 1D example
...
def cumsum(
    ...
    --------
    >>> import numpy as np
    >>> from kung_fu_pandas.groupby.numba import cumsum
    >>>
    >>> # Basic usage
    >>> group_key = np.array([0, 0, 0, 1, 1, 1])
...
def cumcount(
    ...
    --------
    >>> import numpy as np
    >>> from kung_fu_pandas.groupby.numba import cumcount
    >>>
    >>> # Basic usage
    >>> group_key = np.array([0, 0, 0, 1, 1, 1])
...
def cummin(
    ...
    --------
    >>> import numpy as np
    >>> from kung_fu_pandas.groupby.numba import cummin
    >>>
    >>> # Basic usage
    >>> group_key = np.array([0, 0, 0, 1, 1, 1])
...
def cummax(
    ...
    --------
    >>> import numpy as np
    >>> from kung_fu_pandas.groupby.numba import cummax
    >>>
    >>> # Basic usage
    >>> group_key = np.array([0, 0, 0, 1, 1, 1])
